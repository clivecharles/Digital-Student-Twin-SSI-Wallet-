...
const InsuranceProofApplicant = (props) => {
      ...
      <Grid item container sm={6}>
        ...
        <Grid item sm={6}>
          <TextField
            ...
            id="standard-read-only-input"
            label="Insurance Nr"
            defaultValue={props.data.insuranceNr}
            inputprops={{
              readOnly: true,
            }}
            variant="standard"
...
export default InsuranceProofApplicant;
